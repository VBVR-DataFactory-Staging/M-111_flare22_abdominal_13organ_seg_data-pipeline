...
class TaskConfig(PipelineConfig):
    ...
    domain: str = Field(default="flare22_abdominal_13organ_seg")
    ...
    task_prompt: str = Field(
        default="This abdominal CT slice (FLARE22). Segment 13 abdominal organs with distinct colors (liver, spleen, kidneys, pancreas, gallbladder, stomach, aorta, etc.).",
